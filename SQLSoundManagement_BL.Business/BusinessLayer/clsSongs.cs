...
namespace SQLSoundManagement_BL.BusinessLayer
{
    public class clsSongs : BusinessObjectBase
    {
        ...
        public bool AlternativeChart
        {
            get { return _AlternativeChart; }
            set
            {
                if (_AlternativeChart != value)
                {
                    _AlternativeChart = value;
                    PropertyHasChanged("AlternativeChart");
                }
            }
        }
