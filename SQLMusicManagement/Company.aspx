<%@ Page Title="" Language="C#" MasterPageFile="~/sqlmusic.Master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="SQLMusicManagement.Company" %>
    ...
    <div id="container">
        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" CssClass="Grid"
            ...
            <Columns>
                ...
                <asp:TemplateField SortExpression="Company" HeaderText="Short Name">
                    <ItemTemplate>
